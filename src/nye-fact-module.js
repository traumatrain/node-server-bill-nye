...
const nyeFacts = [
  ...
  'In 2005, Bill became The Planetary Societys vice president, and this society advocated space research especially on other planets—Mars in particular',
  'Bill Nye holds several U.S. patents which include ballet pointe shoes and an educational magnifying glass which can be created by filling a plastic bag with some water',
  'Bill Nye has lived in Los Angeles since 2006',
  'Bill Nye served as a university professor at Cornell University.',
  'Nye is also a fellow of the Committee for Skeptical Inquiry',
  'He has received an honorary doctorate award from the Johns Hopkins University, and an Honorary Doctor of Science degree from Willamette University among other awards',
  'He is a self-proclaimed lover of swing, and has been spotted having fun in dancing venues in the Los Angeles area.',
  'He featured in the 13-episode series from PBS KCTS-TV which was called “The Eyes of Nye”.',
];
